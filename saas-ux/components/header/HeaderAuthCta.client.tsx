    ...
    <SignedOut>
      <div className="flex items-center gap-2">
        ...
        <SignInButton mode="modal">
          <button className="text-sm text-sky-600 hover:text-sky-700 underline-offset-2 hover:underline hover:cursor-pointer transition">
            {t ? t("signIn") : "Sign in"}
          </button>
        </SignInButton>
      </div>
