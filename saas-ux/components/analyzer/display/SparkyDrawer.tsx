// components/analyzer/display/SparkyDrawer.tsx
"use client";
...
export default function SparkyDrawer() {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-0 top-1/2 -translate-y-1/2 z-40 bg-gradient-to-l from-sky-500 to-purple-500 text-white px-3 py-6 rounded-l-lg shadow-lg hover:shadow-xl transition-all hover:pr-4 group cursor-pointer"
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-xl bg-gradient-to-r from-sky-500 to-purple-500 p-6 text-center">
            <h3 className="text-lg font-bold text-white mb-2">
              Unlock Full Sparky Access
            </h3>
            <p className="text-sm text-white/80 mb-4">
              Sign up now to activate your AI assistant and start optimizing!
            </p>
            <button className="w-full bg-white text-neutral-900 font-semibold py-3 px-4 rounded-lg hover:bg-neutral-100 transition-colors inline-flex items-center justify-center gap-2 cursor-pointer">
              Start Free Trial
