...
/**
 * Shopify logomark
 * Uses `currentColor` for the main fill, with hardcoded colors for the shopping bag design
 * Example: <ShopifyIcon size={24} className="text-[#95BF47]" />
 *
 * Official Shopify green: #95BF47
 */

import type { ComponentType } from "react";

export const ShopifyIcon: ComponentType<{
  size?: number;
  className?: string;
}> = ({ size = 24, className = "" }) => {
  return (
