// components/icons/WordPress.tsx
/**
 * WordPress logomark
 * Uses `currentColor` so you can style via Tailwind classes
 * Example: <WordPressIcon size={24} className="text-[#21759B]" />
 *
 * Official WordPress blue: #21759B
 */

import type { ComponentType } from "react";

export const WordPressIcon: ComponentType<{
  size?: number;
  className?: string;
}> = ({ size = 24, className = "" }) => {
  return (
