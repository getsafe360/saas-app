// saas-ux/components/icons/WordPress.tsx
"use client";
import * as React from "react";

type WordPressIconProps = React.SVGProps<SVGSVGElement> & {
  size?: number;
  title?: string;
};
...
/**
 * WordPress logomark
 * - Uses `currentColor` so you can style via Tailwind classes (e.g. text-[#21759B])
 * - Pass `size` or set width/height via CSS
 */
